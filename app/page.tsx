  ...
  return (
    <div className="divide-y divide-gray-100 dark:divide-gray-700">
      ...
      <div className="items-center space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
        <div className="flex flex-col items-center pt-8 xl:h-full xl:justify-start">
          <Image
            alt="my photo"
            src={photo}
          ...
          <div className="flex space-x-5 pt-6">
            <a href="https://github.com/fcbjimmy" target="_blank">
              <svg
            ...
            <a href="https://www.linkedin.com/in/jimmychan11/" target="_blank">
              <svg
                viewBox="0 0 1024 1024"
                fill="currentColor"
                className="w-8 h-8 text-teal-500 hover:text-teal-600"
            ...
            <a
              href="mailto: jim_culers@gmail.com?subject=Hey Jimmy"
              target="_blank"
            >
              <svg
                viewBox="0 0 1024 1024"
